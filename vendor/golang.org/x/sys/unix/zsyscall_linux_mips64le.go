...
func Seek(fd int, offset int64, whence int) (off int64, err error) {mydebug.INFO()
...
func Shutdown(fd int, how int) (err error) {mydebug.INFO()
...
func Splice(rfd int, roff *int64, wfd int, woff *int64, len int, flags int) (n int64, err error) {mydebug.INFO()
...
func fstat(fd int, st *stat_t) (err error) {mydebug.INFO()
...
func lstat(path string, st *stat_t) (err error) {mydebug.INFO()
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil {
		return
...
func stat(path string, st *stat_t) (err error) {mydebug.INFO()
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil {
		return
