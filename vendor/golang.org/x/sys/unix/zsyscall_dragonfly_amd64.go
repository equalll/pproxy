...
func extpread(fd int, p []byte, flags int, offset int64) (n int, err error) {mydebug.INFO()
	var _p0 unsafe.Pointer
	if len(p) > 0 {
		_p0 = unsafe.Pointer(&p[0])
	} else {
...
func extpwrite(fd int, p []byte, flags int, offset int64) (n int, err error) {mydebug.INFO()
	var _p0 unsafe.Pointer
	if len(p) > 0 {
		_p0 = unsafe.Pointer(&p[0])
	} else {
