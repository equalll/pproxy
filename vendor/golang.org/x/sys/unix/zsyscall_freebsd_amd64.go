...
func kevent(kq int, change unsafe.Pointer, nchange int, event unsafe.Pointer, nevent int, timeout *Timespec) (n int, err error) {mydebug.INFO()
...
func sysctl(mib []_C_int, old *byte, oldlen *uintptr, new *byte, newlen uintptr) (err error) {mydebug.INFO()
	var _p0 unsafe.Pointer
	if len(mib) > 0 {
...
func utimes(path string, timeval *[2]Timeval) (err error) {mydebug.INFO()
	var _p0 *byte
...
func futimes(fd int, timeval *[2]Timeval) (err error) {mydebug.INFO()
...
func pipe() (r int, w int, err error) {mydebug.INFO()
...
func Chflags(path string, flags int) (err error) {mydebug.INFO()
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil {
		return
...
func Dup2(from int, to int) (err error) {mydebug.INFO()
...
func ExtattrGetFd(fd int, attrnamespace int, attrname string, data uintptr, nbytes int) (ret int, err error) {mydebug.INFO()
	var _p0 *byte
...
func ExtattrSetFd(fd int, attrnamespace int, attrname string, data uintptr, nbytes int) (ret int, err error) {mydebug.INFO()
	var _p0 *byte
	_p0, err = BytePtrFromString(attrname)
	if err != nil {
		return
...
func ExtattrDeleteFd(fd int, attrnamespace int, attrname string) (err error) {mydebug.INFO()
	var _p0 *byte
	_p0, err = BytePtrFromString(attrname)
	if err != nil {
		return
...
func ExtattrListFd(fd int, attrnamespace int, data uintptr, nbytes int) (ret int, err error) {mydebug.INFO()
...
func ExtattrGetFile(file string, attrnamespace int, attrname string, data uintptr, nbytes int) (ret int, err error) {mydebug.INFO()
	var _p0 *byte
...
func ExtattrSetFile(file string, attrnamespace int, attrname string, data uintptr, nbytes int) (ret int, err error) {mydebug.INFO()
	var _p0 *byte
	_p0, err = BytePtrFromString(file)
	if err != nil {
		return
...
func ExtattrDeleteFile(file string, attrnamespace int, attrname string) (err error) {mydebug.INFO()
	var _p0 *byte
	_p0, err = BytePtrFromString(file)
	if err != nil {
		return
...
func ExtattrListFile(file string, attrnamespace int, data uintptr, nbytes int) (ret int, err error) {mydebug.INFO()
	var _p0 *byte
	_p0, err = BytePtrFromString(file)
	if err != nil {
		return
...
func ExtattrGetLink(link string, attrnamespace int, attrname string, data uintptr, nbytes int) (ret int, err error) {mydebug.INFO()
	var _p0 *byte
...
func ExtattrSetLink(link string, attrnamespace int, attrname string, data uintptr, nbytes int) (ret int, err error) {mydebug.INFO()
	var _p0 *byte
	_p0, err = BytePtrFromString(link)
	if err != nil {
		return
...
func ExtattrDeleteLink(link string, attrnamespace int, attrname string) (err error) {mydebug.INFO()
	var _p0 *byte
	_p0, err = BytePtrFromString(link)
	if err != nil {
		return
...
func ExtattrListLink(link string, attrnamespace int, data uintptr, nbytes int) (ret int, err error) {mydebug.INFO()
	var _p0 *byte
	_p0, err = BytePtrFromString(link)
	if err != nil {
		return
...
func Fchflags(fd int, flags int) (err error) {mydebug.INFO()
...
func Fstatfs(fd int, stat *Statfs_t) (err error) {mydebug.INFO()
...
func Getdtablesize() (size int) {mydebug.INFO()
...
func Geteuid() (uid int) {mydebug.INFO()
...
func Getpgrp() (pgrp int) {mydebug.INFO()
...
func Getsid(pid int) (sid int, err error) {mydebug.INFO()
...
func Issetugid() (tainted bool) {mydebug.INFO()
...
func Kqueue() (fd int, err error) {mydebug.INFO()
...
func Revoke(path string) (err error) {mydebug.INFO()
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil {
		return
...
func Select(n int, r *FdSet, w *FdSet, e *FdSet, timeout *Timeval) (err error) {mydebug.INFO()
...
func Setlogin(name string) (err error) {mydebug.INFO()
	var _p0 *byte
...
func Settimeofday(tp *Timeval) (err error) {mydebug.INFO()
...
func Statfs(path string, stat *Statfs_t) (err error) {mydebug.INFO()
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil {
		return
...
func Umask(newmask int) (oldmask int) {mydebug.INFO()
...
func Undelete(path string) (err error) {mydebug.INFO()
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil {
		return
...
func Unmount(path string, flags int) (err error) {mydebug.INFO()
	var _p0 *byte
	_p0, err = BytePtrFromString(path)
	if err != nil {
		return
...
func accept4(fd int, rsa *RawSockaddrAny, addrlen *_Socklen, flags int) (nfd int, err error) {mydebug.INFO()
