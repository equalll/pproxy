...
func kill(pid int, signum int, posix int) (err error) {mydebug.INFO()
...
func Exchangedata(path1 string, path2 string, options int) (err error) {mydebug.INFO()
	var _p0 *byte
...
func Setprivexec(flag int) (err error) {mydebug.INFO()
...
func gettimeofday(tp *Timeval) (sec int32, usec int32, err error) {mydebug.INFO()
