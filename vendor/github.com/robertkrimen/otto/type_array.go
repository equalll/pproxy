...
func (runtime *_runtime) newArrayObject(length uint32) *_object {mydebug.INFO()
...
func isArray(object *_object) bool {mydebug.INFO()
	return object != nil && (object.class == "Array" || object.class == "GoArray")
}

func objectLength(object *_object) uint32 {mydebug.INFO()
	if object == nil {
		return 0
	}
	switch object.class {
...
func arrayUint32(rt *_runtime, value Value) uint32 {mydebug.INFO()
	nm := value.number()
...
func arrayDefineOwnProperty(self *_object, name string, descriptor _property, throw bool) bool {mydebug.INFO()
