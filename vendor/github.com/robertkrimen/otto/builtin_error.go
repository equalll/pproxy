...
func builtinError(call FunctionCall) Value {mydebug.INFO()
	return toValue_object(call.runtime.newError("Error", call.Argument(0), 1))
}

func builtinNewError(self *_object, argumentList []Value) Value {mydebug.INFO()
	return toValue_object(self.runtime.newError("Error", valueOfArrayIndex(argumentList, 0), 0))
}

func builtinError_toString(call FunctionCall) Value {mydebug.INFO()
