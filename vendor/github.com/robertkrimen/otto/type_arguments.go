...
func (runtime *_runtime) newArgumentsObject(indexOfParameterName []string, stash _stash, length int) *_object {mydebug.INFO()
...
func (in _argumentsObject) clone(clone *_clone) _argumentsObject {mydebug.INFO()
...
func (self _argumentsObject) get(name string) (Value, bool) {mydebug.INFO()
...
func (self _argumentsObject) put(name string, value Value) {mydebug.INFO()
	index := stringToArrayIndex(name)
	name = self.indexOfParameterName[index]
	self.stash.setBinding(name, value, false)
}

func (self _argumentsObject) delete(name string) {mydebug.INFO()
	index := stringToArrayIndex(name)
	self.indexOfParameterName[index] = ""
}

func argumentsGet(self *_object, name string) Value {mydebug.INFO()
...
func argumentsGetOwnProperty(self *_object, name string) *_property {mydebug.INFO()
...
func argumentsDefineOwnProperty(self *_object, name string, descriptor _property, throw bool) bool {mydebug.INFO()
...
func argumentsDelete(self *_object, name string, throw bool) bool {mydebug.INFO()
