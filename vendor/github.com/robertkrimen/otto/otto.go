...
import "github.com/equalll/mydebug"
    ...
    func runUnsafe(unsafe string) {mydebug.INFO()
        start := time.Now()
        defer func() {
...
func (otto *Otto) clone() *Otto {mydebug.INFO()
	self := &Otto{
...
//
func Run(src interface{}) (*Otto, Value, error) {mydebug.INFO()
	otto := New()
...
// src may also be a Program, but if the AST has been modified, then runtime behavior is undefined.
//
func (self Otto) Run(src interface{}) (Value, error) {mydebug.INFO()
...
func (self Otto) Eval(src interface{}) (Value, error) {mydebug.INFO()
...
// will be undefined.
func (self Otto) Get(name string) (Value, error) {mydebug.INFO()
	value := Value{}
	err := catchPanic(func() {
...
func (self Otto) getValue(name string) Value {mydebug.INFO()
...
func (self Otto) Set(name string, value interface{}) error {mydebug.INFO()
	{
...
func (self Otto) setValue(name string, value Value) {mydebug.INFO()
	self.runtime.globalStash.setValue(name, value, false)
}

func (self Otto) SetDebuggerHandler(fn func(vm *Otto)) {mydebug.INFO()
	self.runtime.debugger = fn
}

func (self Otto) SetRandomSource(fn func() float64) {mydebug.INFO()
...
func (self Otto) SetStackDepthLimit(limit int) {mydebug.INFO()
...
func (self Otto) SetStackTraceLimit(limit int) {mydebug.INFO()
...
func (self Otto) MakeCustomError(name, message string) Value {mydebug.INFO()
...
// returning it as a Value.
func (self Otto) MakeRangeError(message string) Value {mydebug.INFO()
...
// returning it as a Value.
func (self Otto) MakeSyntaxError(message string) Value {mydebug.INFO()
...
// returning it as a Value.
func (self Otto) MakeTypeError(message string) Value {mydebug.INFO()
...
func (self Otto) Context() Context {mydebug.INFO()
...
func (self Otto) ContextLimit(limit int) Context {mydebug.INFO()
...
func (self Otto) ContextSkip(limit int, skipNative bool) (ctx Context) {mydebug.INFO()
...
//
func (self Otto) Call(source string, this interface{}, argumentList ...interface{}) (Value, error) {mydebug.INFO()
...
func (self Otto) Object(source string) (*Object, error) {mydebug.INFO()
...
func (self Otto) ToValue(value interface{}) (Value, error) {mydebug.INFO()
...
func (in *Otto) Copy() *Otto {mydebug.INFO()
	out := &Otto{
...
func _newObject(object *_object, value Value) *Object {mydebug.INFO()
...
//
func (self Object) Call(name string, argumentList ...interface{}) (Value, error) {mydebug.INFO()
...
func (self Object) Value() Value {mydebug.INFO()
	return self.value
}

// Get the value of the property with the given name.
func (self Object) Get(name string) (Value, error) {mydebug.INFO()
	value := Value{}
	err := catchPanic(func() {
...
func (self Object) Set(name string, value interface{}) error {mydebug.INFO()
	{
...
func (self Object) Keys() []string {mydebug.INFO()
	var keys []string
...
func (self Object) KeysByParent() [][]string {mydebug.INFO()
	var a [][]string
...
//		RegExp
//
func (self Object) Class() string {mydebug.INFO()
