...
func (in *_runtime) clone() *_runtime {mydebug.INFO()
...
func (clone *_clone) object(in *_object) *_object {mydebug.INFO()
...
func (clone *_clone) dclStash(in *_dclStash) (*_dclStash, bool) {mydebug.INFO()
...
func (clone *_clone) objectStash(in *_objectStash) (*_objectStash, bool) {mydebug.INFO()
...
func (clone *_clone) fnStash(in *_fnStash) (*_fnStash, bool) {mydebug.INFO()
...
func (clone *_clone) value(in Value) Value {mydebug.INFO()
	out := in
...
func (clone *_clone) valueArray(in []Value) []Value {mydebug.INFO()
...
func (clone *_clone) stash(in _stash) _stash {mydebug.INFO()
	if in == nil {
		return nil
	}
...
func (clone *_clone) property(in _property) _property {mydebug.INFO()
	out := in
...
func (clone *_clone) dclProperty(in _dclProperty) _dclProperty {mydebug.INFO()
	out := in
