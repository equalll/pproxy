...
func (self *_objectStash) runtime() *_runtime {mydebug.INFO()
	return self._runtime
}

func (runtime *_runtime) newObjectStash(object *_object, outer _stash) *_objectStash {mydebug.INFO()
	if object == nil {
...
func (in *_objectStash) clone(clone *_clone) _stash {mydebug.INFO()
...
func (self *_objectStash) hasBinding(name string) bool {mydebug.INFO()
	return self.object.hasProperty(name)
}

func (self *_objectStash) createBinding(name string, deletable bool, value Value) {mydebug.INFO()
...
func (self *_objectStash) setBinding(name string, value Value, strict bool) {mydebug.INFO()
	self.object.put(name, value, strict)
}

func (self *_objectStash) setValue(name string, value Value, throw bool) {mydebug.INFO()
...
func (self *_objectStash) getBinding(name string, throw bool) Value {mydebug.INFO()
	if self.object.hasProperty(name) {
...
func (self *_objectStash) deleteBinding(name string) bool {mydebug.INFO()
	return self.object.delete(name, false)
}

func (self *_objectStash) outer() _stash {mydebug.INFO()
	return self._outer
}

func (self *_objectStash) newReference(name string, strict bool, at _at) _reference {mydebug.INFO()
...
func (runtime *_runtime) newDeclarationStash(outer _stash) *_dclStash {mydebug.INFO()
	return &_dclStash{
		_runtime: runtime,
		_outer:   outer,
		property: map[string]_dclProperty{},
...
func (in *_dclStash) clone(clone *_clone) _stash {mydebug.INFO()
...
func (self *_dclStash) hasBinding(name string) bool {mydebug.INFO()
	_, exists := self.property[name]
	return exists
}

func (self *_dclStash) runtime() *_runtime {mydebug.INFO()
	return self._runtime
}

func (self *_dclStash) createBinding(name string, deletable bool, value Value) {mydebug.INFO()
	_, exists := self.property[name]
	if exists {
...
func (self *_dclStash) setBinding(name string, value Value, strict bool) {mydebug.INFO()
...
func (self *_dclStash) setValue(name string, value Value, throw bool) {mydebug.INFO()
	if !self.hasBinding(name) {
...
func (self *_dclStash) getBinding(name string, throw bool) Value {mydebug.INFO()
	property, exists := self.property[name]
	if !exists {
...
func (self *_dclStash) deleteBinding(name string) bool {mydebug.INFO()
	property, exists := self.property[name]
	if !exists {
		return true
	}
...
func (self *_dclStash) outer() _stash {mydebug.INFO()
	return self._outer
}

func (self *_dclStash) newReference(name string, strict bool, _ _at) _reference {mydebug.INFO()
...
func (runtime *_runtime) newFunctionStash(outer _stash) *_fnStash {mydebug.INFO()
	return &_fnStash{
		_dclStash: _dclStash{
			_runtime: runtime,
			_outer:   outer,
...
func (in *_fnStash) clone(clone *_clone) _stash {mydebug.INFO()
...
func getStashProperties(stash _stash) (keys []string) {mydebug.INFO()
